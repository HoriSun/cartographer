...
function(_protobuf_find_libraries name filename)
  message(STATUS "=========== $ENV{PROTOBUF_ROOT}/lib")
  message(STATUS "=========== $ENV{PROTOBUF_LIB_DIR}")
  ...
  unset(${name}_LIBRARIES PARENT_SCOPE)
  unset(${name}_LIBRARY PARENT_SCOPE)
  message(STATUS "====================== ${name}_LIBRARIES=${${name}_LIBRARIES}")
  message(STATUS "====================== ${name}_LIBRARY=${${name}_LIBRARY}")
  find_library(${name}_LIBRARIES
    NAMES ${filename}
    HINTS ENV PROTOBUF_ROOT
    PATHS ENV PROTOBUF_ROOT
    PATH_SUFFIXES lib)
  set(${name}_LIBRARY ${${name}_LIBRARIES})
  set(${name}_LIBRARY "${${name}_LIBRARY}" PARENT_SCOPE)
  set(${name}_LIBRARIES "${${name}_LIBRARIES}" PARENT_SCOPE)
  message(STATUS "====================== ${name}_LIBRARIES =${${name}_LIBRARIES}")
  message(STATUS "====================== ${name}_LIBRARIES_=${${name}_LIBRARIES_}")
  message(STATUS "====================== ${name}_LIBRARY=${${name}_LIBRARY}")
